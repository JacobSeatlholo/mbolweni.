    ...
    <>
      ...
      <section className="flex justify-center items-center ">
        <div className="m-3 space-y-3 w-[400px]  flex justify-center items-center flex-col">
          ...
          <Separator className="bg-[#afafaf]" />
          <div className="flex justify-center items-center  w-[300px] py-2">
            <Button className="font-semibold text-sm text-black hover:bg-[#eee] bg-transparent border-none shadow-transparent flex gap-2 justify-center items-center rounded-[10px]">
              <svg
                width="15"
                height="14"
                viewBox="0 0 15 14"
